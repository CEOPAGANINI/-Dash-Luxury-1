  ...
  return (
    ...
    >
      ...
      <div className={styles.monitoringNote}>
        ...
        <p>
          CPU, memória, disco e tempo de atividade aparecem após a conexão. Sem
          servidor, não há métricas para exibir.
        </p>
      </div>
    </aside>
  );
    ...
    <div className={styles.preparation} id="preparar-vps">
      ...
      >
        ...
        <div className={styles.requirementRows}>
          ...
          <div>
            ...
            <div>
              ...
              <p>
                Console com root ou sudo, portas 80 e 443 liberadas no provedor
                e relógio sincronizado.
              </p>
            </div>
          </div>
          <div>
            ...
            <div>
              ...
              <p>
                Até 3 MB, com index.html na raiz, CSS, JavaScript e imagens. Sem
                PHP e sem .htaccess.
              </p>
            </div>
          </div>
        ...
        <div className={styles.requirementFooter}>
          ...
          <span>
            Você confirma a identidade do servidor antes de liberar as tarefas.
          </span>
        </div>
      </section>
